<template>
    <!-- Features Start -->
    <div class="container-fluid feature mt-5 wow fadeInUp" data-wow-delay="0.1s" id="#category">
        <div class="container p-5" >
            <div class="row g-0">
                <div class="col-lg pt-lg-5 mb-5">
                    <div class="bg-white p-5 mt-lg-5">
                        <h1 class="display-6 mb-4 wow fadeIn" data-wow-delay="0.3s">Ensure with the best Technology</h1>
                        ...
                        <div class="row g-5 pt-2 mb-5">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <h5 class="mb-3">AI-Powered Job Search</h5>
                                <span>Find the Perfect Opportunity with Advanced Algorithms</span>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                                <div class="icon-box-primary mb-4">
                                    <i class="bi bi-search text-dark"></i>
                                </div>
                                <h5 class="mb-3">Smart Worker Search</h5>
                                <span>Connect with Top Talent Effortlessly</span>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary p-5">
                                <div class="experience mb-4 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-white">Workers skill</span>
